...
public class SampleTest {
    ...
    @Test
    void test1() {
        log.info("Executing Container2.test1()");
        assertThat(FAIL_REASON, 1, equalTo(1));
    }

    @Test
    void test2() {
        log.info("Executing Container2.test2()");
        assertThat(FAIL_REASON, 1, equalTo(2));
    }

    @Test
    void test3() {
        log.info("Executing Container2.test3()");
        assertThat(FAIL_REASON, 1, equalTo(1));
    }

    @Test
    void test4() {
        log.info("Executing Container2.test4()");
        assertThat(FAIL_REASON, 1, equalTo(1));
    }
}
